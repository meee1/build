...
$(NUTTX_OUTDIR)/abies/audio/nuttx/nuttx.a: FORCE
	$(hide) $(NUTTX_ROOT)/nuttx/tools/configure.sh -o $(dir $@) song/abies/audio
	$(hide) $(MAKE) -C $(NUTTX_ROOT)/nuttx O=$(dir $@) V=$(if $(hide),0,1)
	$(hide) $(MAKE) -C $(NUTTX_ROOT)/nuttx O=$(dir $@) savedefconfig
	$(hide) cp $(dir $@)/defconfig ${NUTTX_ROOT}/nuttx/configs/song/abies/audio
...
$(NUTTX_OUTDIR)/banks/audio/nuttx/nuttx.a: FORCE
	$(hide) $(NUTTX_ROOT)/nuttx/tools/configure.sh -o $(dir $@) song/banks/audio
	$(hide) $(MAKE) -C $(NUTTX_ROOT)/nuttx O=$(dir $@) V=$(if $(hide),0,1)
	$(hide) $(MAKE) -C $(NUTTX_ROOT)/nuttx O=$(dir $@) savedefconfig
	$(hide) cp $(dir $@)/defconfig ${NUTTX_ROOT}/nuttx/configs/song/banks/audio
...
$(NUTTX_OUTDIR)/banks/rpm/nuttx/nuttx: FORCE
	$(hide) $(NUTTX_ROOT)/nuttx/tools/configure.sh -o $(dir $@) song/banks/rpm
	$(hide) $(MAKE) -C $(NUTTX_ROOT)/nuttx O=$(dir $@) V=$(if $(hide),0,1)
	$(hide) $(MAKE) -C $(NUTTX_ROOT)/nuttx O=$(dir $@) savedefconfig
	$(hide) cp $(dir $@)/defconfig ${NUTTX_ROOT}/nuttx/configs/song/banks/rpm
...
$(NUTTX_OUTDIR)/banks/sensor/nuttx/nuttx: FORCE
	$(hide) $(NUTTX_ROOT)/nuttx/tools/configure.sh -o $(dir $@) song/banks/sensor
	$(hide) $(MAKE) -C $(NUTTX_ROOT)/nuttx O=$(dir $@) V=$(if $(hide),0,1)
	$(hide) $(MAKE) -C $(NUTTX_ROOT)/nuttx O=$(dir $@) savedefconfig
	$(hide) cp $(dir $@)/defconfig ${NUTTX_ROOT}/nuttx/configs/song/banks/sensor
...
$(NUTTX_OUTDIR)/banks/vision/nuttx/nuttx.a: FORCE
	$(hide) $(NUTTX_ROOT)/nuttx/tools/configure.sh -o $(dir $@) song/banks/vision
	$(hide) $(MAKE) -C $(NUTTX_ROOT)/nuttx O=$(dir $@) V=$(if $(hide),0,1) LM_LICENSE_FILE=27000@10.235.240.245
	$(hide) $(MAKE) -C $(NUTTX_ROOT)/nuttx O=$(dir $@) savedefconfig
	$(hide) cp $(dir $@)/defconfig ${NUTTX_ROOT}/nuttx/configs/song/banks/vision
